...
chelsea = Workout.create(name: "Chelsea", group: "Girls", category: "EMOM", description: "Every minute on the minute for 30 minutes: 5 pull-ups, 10 push-ups, 15 squats. If there is any time left in each minute, rest until the next minute starts.")
